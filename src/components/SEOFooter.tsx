  ...
  return (
    <footer className="mt-16 border-t border-white/5 pt-10 pb-8 text-left space-y-10">
      ...
      <section aria-labelledby="footer-about-heading">
        <h2 id="footer-about-heading" className="text-lg font-bold text-white mb-3 flex items-center gap-2">
      ...
      {/* Features Grid */}
      <section aria-labelledby="footer-features-heading">
        <h2 id="footer-features-heading" className="text-lg font-bold text-white mb-4">Key Features</h2>
      ...
      {/* How It Works */}
      <section aria-labelledby="footer-how-heading">
        <h2 id="footer-how-heading" className="text-lg font-bold text-white mb-3">How Does It Work?</h2>
      ...
      <section aria-labelledby="footer-faq-heading">
        <h2 id="footer-faq-heading" className="text-lg font-bold text-white mb-3">Frequently Asked Questions</h2>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-white/5">
        <div className="flex items-center gap-3">
          <img src="/favicon.png" alt="MephistoVault Logo" className="w-6 h-6 rounded" />
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="text-slate-500 hover:text-white transition-colors text-sm flex items-center gap-1.5 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 rounded-md"
